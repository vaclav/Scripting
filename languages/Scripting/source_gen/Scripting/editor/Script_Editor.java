...
public class Script_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_udqu28_a(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createRefNodeList_udqu28_f0(editorContext, node));
    return editorCell;
  }
  ...
  private EditorCell createRefNodeList_udqu28_f0(EditorContext editorContext, SNode node) {
    AbstractCellListHandler handler = new Script_Editor.staticInnerClassifiersListHandler_udqu28_f0(node, "staticInnerClassifiers", editorContext);
  ...
  private static class staticInnerClassifiersListHandler_udqu28_f0 extends RefNodeListHandler {
    public staticInnerClassifiersListHandler_udqu28_f0(SNode ownerNode, String childRole, EditorContext context) {
    ...
    public EditorCell createEmptyCell_internal(EditorContext editorContext, SNode node) {
      return this.createConstant_udqu28_a5a(editorContext, node);
    }
    ...
    private EditorCell createConstant_udqu28_a5a(EditorContext editorContext, SNode node) {
      EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, "");
      editorCell.setCellId("Constant_udqu28_a5a");
      {
        Style style = editorCell.getStyle();
