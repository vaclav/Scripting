...
public class Script_Behavior {
  ...
  public static Iterable<SNode> call_retrieveStaticFields_6240804956234829477(SNode thisNode) {
    return ListSequence.fromList(SLinkOperations.getTargets(SLinkOperations.getTarget(thisNode, "body", true), "statement", true)).where(new IWhereFilter<SNode>() {
      public boolean accept(SNode it) {
        return SNodeOperations.isInstanceOf(it, "Scripting.structure.StaticFieldDeclarationInScript");
      }
  ...
  public static Iterable<SNode> call_retrieveFields_6240804956234829751(SNode thisNode) {
    return ListSequence.fromList(SLinkOperations.getTargets(SLinkOperations.getTarget(thisNode, "body", true), "statement", true)).where(new IWhereFilter<SNode>() {
      public boolean accept(SNode it) {
        return SNodeOperations.isInstanceOf(it, "Scripting.structure.FieldDeclarationInScript");
      }
  ...
  public static Scope virtual_getScope_3734116213129936182(SNode thisNode, SNode kind, SNode child) {
    if (SConceptOperations.isSubConceptOf(kind, "jetbrains.mps.baseLanguage.structure.BaseMethodDeclaration")) {
      return Script_Behavior.call_createScope_6240804956234810155(thisNode, Sequence.fromIterable(Script_Behavior.call_retrieveStaticMethodDeclarations_6240804956234706787(thisNode)).concat(Sequence.fromIterable(Script_Behavior.call_retrieveInstanceMethodDeclarations_6240804956234799549(thisNode))));
    } else if (SConceptOperations.isSubConceptOf(kind, "jetbrains.mps.baseLanguage.structure.BaseVariableDeclaration")) {
      return Script_Behavior.call_createScope_6240804956234810155(thisNode, Sequence.fromIterable(Script_Behavior.call_retrieveStaticFieldDeclarations_6240804956234802612(thisNode)).concat(Sequence.fromIterable(Script_Behavior.call_retrieveFieldDeclarations_6240804956234802648(thisNode))));
    }
    return null;
  }
